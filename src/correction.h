...
namespace stormphrax
{
	...
	public:
		...
		{
			m_table[static_cast<i32>(pos.toMove())][pos.nonPawnKey() % Entries].update(depth, searchScore, staticEval);
		}

		[[nodiscard]] inline auto correct(const Position &pos, Score score) const
		{
			return m_table[static_cast<i32>(pos.toMove())][pos.nonPawnKey() % Entries].correct(score);
		}
