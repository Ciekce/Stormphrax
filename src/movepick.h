...
namespace stormphrax
{
	...
	public:
		...
		{
			return MoveGenerator(MovegenStage::TtMove, pos, data, ttMove, history, continuations, ply);
		}
		...
		{
			return MoveGenerator(MovegenStage::ProbcutTtMove, pos, data, ttMove, history, {}, 0);
		}
