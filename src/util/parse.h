...
namespace stormphrax::util {
    ...
    tryParseU32(const std::string &value, u32 radix = 10) -> std::optional<u32> {
        try {
    ...
    [[nodiscard]] inline auto
    tryParseI32(const std::string &value, u32 radix = 10) -> std::optional<i32> {
        try {
    ...
    [[nodiscard]] inline auto
    tryParseU64(const std::string &value, u32 radix = 10) -> std::optional<u64> {
        try {
    ...
    [[nodiscard]] inline auto
    tryParseI64(const std::string &value, u32 radix = 10) -> std::optional<i64> {
        try {
    ...
    [[nodiscard]] inline auto
    tryParseSize(const std::string &value, u32 radix = 10) -> std::optional<usize> {
