    ...
    private:
        ...
        static inline auto update(
            ...
            } else if (addCount == 2 && subCount == 2) // castling
            {
                ...
                curr.acc.subSubAddAddFrom(
                    prev,
                    g_network.featureTransformer(),
                    c,
                    sub0,
                    sub1,
                    add0,
        ...
        static inline auto refreshAccumulator(
            ...
            for (u32 pieceIdx = 0; pieceIdx < static_cast<u32>(Piece::None); ++pieceIdx) {
                ...
                while (removed) {
                    ...
                    rtEntry.accumulator
                        .deactivateFeature(g_network.featureTransformer(), c, feature);
                }
            }
        ...
        [[nodiscard]] static inline auto
        featureIndex(Color c, Piece piece, Square sq, Square king) -> u32 {
            assert(c != Color::None);
            ...
            const auto bucketOffset =
                InputFeatureSet::getBucket(c, king) * InputFeatureSet::InputSize;
