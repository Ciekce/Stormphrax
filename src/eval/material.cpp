...
#define S(Mg, Eg) \
    ...
    namespace {
        ...
        [[nodiscard]] std::array<std::array<TaperedScore, 64>, 12> createPsts() {
                  ...
                  PieceType::kKing})
            {
                ...
                const auto& bonusTable = kBonusTables[static_cast<i32>(piece)];
...
#undef S
    ...
    const util::MultiArray<TaperedScore, 12, 64> g_pieceSquareTables = createPsts();
} // namespace stormphrax::eval::psqt
