...
#define SP_TUNABLE_ASSERTS(Default, Min, Max, Step) \
	...
	SP_TUNABLE_PARAM(nodeTmBase, 258, 150, 300, 10)
	SP_TUNABLE_PARAM(nodeTmScale, 174, 100, 250, 10)
	SP_TUNABLE_PARAM(nodeTmScaleMin, 108, 1, 1000, 100)

	SP_TUNABLE_PARAM(bmStabilityTmMin, 70, 40, 100, 3)
	SP_TUNABLE_PARAM(bmStabilityTmMax, 256, 120, 1000, 40)
	SP_TUNABLE_PARAM(bmStabilityTmScale, 930, 200, 1500, 65)
	SP_TUNABLE_PARAM(bmStabilityTmOffset, 78, 50, 200, 8)
	SP_TUNABLE_PARAM(bmStabilityTmPower, -280, -400, -150, 13)

	SP_TUNABLE_PARAM(scoreTrendTmMin, 60, 40, 100, 3)
	SP_TUNABLE_PARAM(scoreTrendTmMax, 140, 120, 1000, 40)
	SP_TUNABLE_PARAM(scoreTrendTmScoreScale, 400, 10, 1000, 50)
	SP_TUNABLE_PARAM(scoreTrendTmStretch, 72, 10, 200, 10)
	SP_TUNABLE_PARAM(scoreTrendTmScale, 40, 10, 90, 4)
	SP_TUNABLE_PARAM(scoreTrendTmPositiveScale, 100, 50, 200, 7.5)
	SP_TUNABLE_PARAM(scoreTrendTmNegativeScale, 100, 50, 200, 7.5)
	...
	SP_TUNABLE_PARAM(lmrNonPvReductionScale, 128, 32, 384, 12)
	SP_TUNABLE_PARAM(lmrTtpvReductionScale, 128, 32, 384, 12)
	SP_TUNABLE_PARAM(lmrImprovingReductionScale, 128, 32, 384, 12)
	SP_TUNABLE_PARAM(lmrCheckReductionScale, 128, 32, 384, 12)
	SP_TUNABLE_PARAM(lmrCutnodeReductionScale, 256, 32, 384, 12)
